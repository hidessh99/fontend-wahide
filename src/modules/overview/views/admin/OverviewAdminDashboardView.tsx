...
import { AdminDashboardOverview as OverviewAdminDashboard } from "../../components/admin/OverviewAdminDashboard";

export function OverviewAdminDashboardView() {
  const { adminStats, isLoading, error, refetch } = useDashboardStats();
  const { t } = useI18n();
  ...
  if (!adminStats) return <DashboardSkeleton />;

  return <OverviewAdminDashboard stats={adminStats} />;
}
...
export default OverviewAdminDashboardView;
