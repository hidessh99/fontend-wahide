...
import { useIamAdminUsers } from "@/modules/iam/hooks/useIamAdminUsers";
import { UsersTable } from "@/modules/iam/components/admin/UsersTable";
import { useI18n } from "@/lib/i18n/context";
import { Users } from "lucide-react";

export function IamAdminUsersView() {
  const { t } = useI18n();
  const {
    paginatedUsers,
    isLoading,
...
export default IamAdminUsersView;
