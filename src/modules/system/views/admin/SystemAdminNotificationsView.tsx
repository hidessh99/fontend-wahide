...
import { useSystemAdminNotifications } from "@/modules/system/hooks/useSystemAdminNotifications";
import { BroadcastComposer } from "@/modules/system/components/admin/BroadcastComposer";
import { QueueMonitorTable } from "@/modules/system/components/admin/QueueMonitorTable";
import { NotificationMetricsCards } from "@/modules/system/components/admin/NotificationMetricsCards";
import { Bell } from "lucide-react";
import { useI18n } from "@/lib/i18n/context";

export function SystemAdminNotificationsView() {
  const { t } = useI18n();
  const {
    queues,
    isLoading,
...
export default SystemAdminNotificationsView;
