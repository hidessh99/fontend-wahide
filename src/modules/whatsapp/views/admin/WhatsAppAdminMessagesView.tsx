...
import { useWhatsAppAdminMessageLogs } from "@/modules/whatsapp/hooks/useWhatsAppAdminMessageLogs";
import { MessageLogsTable } from "@/modules/whatsapp/components/admin/MessageLogsTable";
import { MessageMetricsCards } from "@/modules/whatsapp/components/admin/MessageMetricsCards";
import { MessageSquare, ShieldCheck } from "lucide-react";
import { useI18n } from "@/lib/i18n/context";

export function WhatsAppAdminMessagesView() {
  const { t } = useI18n();
  const {
    logs,
    isLoading,
...
export default WhatsAppAdminMessagesView;
