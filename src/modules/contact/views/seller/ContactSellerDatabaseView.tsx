...
import { ContactTable } from "@/modules/contact/components/seller/ContactTable";
...
const ContactModal = dynamic(
  () =>
    import("@/modules/contact/components/seller/ContactModal").then(
      (m) => m.ContactModal,
    ),
  { ssr: false },
);
const ImportCsvModal = dynamic(
  () =>
    import("@/modules/contact/components/seller/ImportCsvModal").then(
      (m) => m.ImportCsvModal,
    ),
  { ssr: false },
);
const DeleteContactModal = dynamic(
  () =>
    import("@/modules/contact/components/seller/DeleteContactModal").then(
...
export function ContactSellerDatabaseView() {
  const { t } = useI18n();
  const {
    contacts,
    filteredContacts,
...
export default ContactSellerDatabaseView;
