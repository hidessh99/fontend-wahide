              ...
              {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Device */}
                    <div className="col-span-2 sm:col-span-3 text-foreground-secondary truncate font-mono text-xs sm:text-sm">
                      {l.device}
                    </div>

                    {/* Time */}
                    <div className="col-span-2 sm:col-span-2 text-right text-foreground-muted font-mono text-xs sm:text-sm">
                      {l.time}
                    </div>
                  </div>
                );
