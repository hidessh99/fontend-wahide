...
export const DEFAULT_POSTS: BlogPost[] = [
  {
    ...
    excerpt: "Panduan lengkap bagaimana arsitektur multi-device whatsmeow dan Spintax Regex mencegah blokir nomor saat broadcast skala besar.",
  ...
  },
  {
    ...
    excerpt: "Cara mengamankan endpoint webhook aplikasi Anda dari serangan replay dan spoofing payload menggunakan header X-Wahide-Signature-256.",
